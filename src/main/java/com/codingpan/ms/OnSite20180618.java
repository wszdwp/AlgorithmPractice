...
public class OnSite20180618 {
  ...
  /**
   * swipe array in four directions, each time just move one step arr[i] range is [2, 2^n] rule 1:
   * if no place stay curr pos rule 2: after moving to the new pos, if neighbor are the same num,
   * added onto the neighbour's cell if neighbour on the moving direction otherwise added on the
   * current pos rule 3:
   */
