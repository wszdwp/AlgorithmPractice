...
public class OTS20190801 {
    /**
     * 给一个string，“aAbeedxXb”，只有a-z, A-Z. 找到一个字母的大小写同时出现在string里。
     * 比如这里是A, E, X。 然后X > E > A。
     */
    ...
    /**
     *  给定一个string，只有小写字母和问号组成，例如"ab?dc?j"，
     *  要求把所有问号替换成小写字母，而且这个替换后的字母不能与相邻的两个字母相同。
...
//        String[] ss = {"", "aaabceddd", "aabbbbcedddd", "aaacccbbb", "aa", "aaa", "aaaaabbbbbbbb"};
