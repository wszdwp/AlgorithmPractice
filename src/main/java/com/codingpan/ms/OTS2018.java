...
public class OTS2018 {
  /**
   * phone # has two wrong format prefix - area - line to area - prefix - line ###631####
   * ###-631-####
   *
   * <p>convert to 631-###-###
   *
  ...
  /**
   * sort color [2,0,2,1,1,0] -> [0,0,1,1,2,2] [1,1,0,0,2,1,0] -> [0,0,0,1,1,1,2]
   *
   * @param nums
   */
  ...
  private TreeNode inPreHelper(
      int[] in, int inL, int inR, int[] pre, int preL, int preR, HashMap<Integer, Integer> inMap) {
  ...
  /**
   * lc61 rotate list Given a linked list, rotate the list to the right by k places, where k is
   * non-negative.
   *
   ...
   *
   * <p>example2 Input: 0->1->2->NULL, k = 4 Output: 2->0->1->NULL
   *
   * <p>Explanation: rotate 1 steps to the right: 2->0->1->NULL rotate 2 steps to the right:
   * 1->2->0->NULL rotate 3 steps to the right: 0->1->2->NULL rotate 4 steps to the right:
   * 2->0->1->NULL
   *
   * @params head, n
   */
  ...
  /**
   * reorder string array to get minimum diff char count pair eg: input: ["car", "bat", "bar"] total
   * sum of neighbor char diff is 2 + 1 = 3 output: ["car", "bar", "bat"] 1 + 1 = 2
   *
   * @param words
   */
  ...
  public static void main(String[] args) {
    ...
    // format phone no
    //        String[] phoneNumbers = {"1236314455", "1236315566", "123-631-4825", "123-6-4825",
    // "123"};
