...
public class Ctx50 {
    ...
    public long[] add(long[] a, long[] b) {
        return reduce(new long[]{a[0] * b[1] + a[1] * b[0], a[1] * b[1]});
    }
    ...
    public long[] mul(long[] a, long[] b) {
        return reduce(new long[]{a[0] * b[0], a[1] * b[1]});
    }

    public long[] div(long[] a, long[] b) {
        return reduce(new long[]{a[0] * b[1], a[1] * b[0]});
    }
    ...
    public boolean judgePoint24(int[] nums) {
        ...
        for (int num : nums) list.add(1.0 * num);
            ...
            for (int j = 0; j < list.size(); j++)
                if (i != j) {
                    for (char op : ops) {
                        ...
                        tmp.clear();
                        tmp.add(res);
                        for (int k = 0; k < list.size(); k++) if (k != i && k != j) tmp.add(list.get(k));
