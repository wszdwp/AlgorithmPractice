...
public class BloombergPhone {
   ...
   *
   * <p>eg: num = 654321, i = 2, j = 3, ans: 653421
   *
   * @param num
   * @param i
   * @param j
  ...
  /**
   * [http://www.1point3acres.com/bbs/thread-302842-1-1.html] leetcode 234 palindrome linked list
  ...
  /**
   * 第二题，已知一个单调递增函数， 请你用这个函数实现它的反函数。用二分法搜索，上下两个边界。 讲完思
   *
   * @param args
   */
