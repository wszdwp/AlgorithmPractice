...
public class LC726NumberOfAtoms {
    ...
    // first name (in sorted order), followed by its count (if that count is more than 1), followed by
    // the second name (in sorted order), followed by its count (if that count is more than 1), and so
    // on.
    //
    //			Example 1:
    //			Input:
    ...
    //			formula will only consist of letters, digits, and round parentheses, and is a valid formula
