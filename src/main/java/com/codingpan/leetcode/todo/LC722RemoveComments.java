...
public class LC722RemoveComments {
  ...
  // source = "string s = "/* Not a comment. */";" will not be a com.codingpan.test case. (Also,
  ...
  //	Example 1:
  //	Input:
  //	source = ["/*Test program */", "int main()", "{ ", "  // variable declaration ", "int a, b,
  // c;", "/* This is a com.codingpan.test", "   multiline  ", "   comment for ", "   testing */",
  // "a = b + c;", "}"]
  //
