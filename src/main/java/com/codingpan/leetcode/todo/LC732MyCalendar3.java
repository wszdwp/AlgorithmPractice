...
public class LC732MyCalendar3 {
  ...
  //	Note:
  //
  //	The number of calls to MyCalendarThree.book per com.codingpan.test case will be at most 400.
  //	In calls to MyCalendarThree.book(start, end), start and end are integers in the range [0,
  // 10^9].

  public LC732MyCalendar3() {}
