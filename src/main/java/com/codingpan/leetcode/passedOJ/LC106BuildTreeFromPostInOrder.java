 ...
 * @author pan
 */
public class LC106BuildTreeFromPostInOrder {
  ...
  private TreeNode helper(
    ...
    root.left =
        helper(inorder, inL, divide - 1, postorder, postL, postL + (divide - inL - 1), inMap);
    root.right =
        helper(inorder, divide + 1, inR, postorder, postR - (inR - divide), postR - 1, inMap);
