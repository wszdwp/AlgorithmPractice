...
public class Utility {
  public static final String PATH =
      "/Users/pan/Documents/Playspace/AlgorithmPractice/src/com/codingpan/leetcode/testcase/";
  ...
  private static TreeNode inPreHelper(
      int[] in, int inL, int inR, int[] pre, int preL, int preR, Map<Integer, Integer> inMap) {
  ...
  private static TreeNode inPostHelper(
      int[] in, int inL, int inR, int[] post, int poL, int poR, Map<Integer, Integer> inMap) {
  ...
  public static void printObjArray(Object[] nums) {
    for (Object n : nums) {
      System.out.print(n + ", ");
    }
    System.out.println();
  ...
  public static void permutate(
      int[] nums, boolean[] used, List<Integer> cur, List<List<Integer>> ans) {
  ...
  public static void combination(
      int[] nums, int d, int n, int s, List<Integer> cur, List<List<Integer>> ans) {
    if (s == n) {
  ...
  /**
   * Unit com.codingpan.test utility functions
   *
   * @param args
   */
