...
//        if (difficulty.length != profit.length || profit.length == 0 || worker.length == 0) return 0;
//
//        int maxProfit = 0;
...
//    }
    ...
    public int maxProfitAssignment(int[] difficulty, int[] profit, int[] worker) {
        ...
        //sort dp {n * 2 dimensional}: if difficult equal, sort by profit DESC, otherwise by difficult ASC
