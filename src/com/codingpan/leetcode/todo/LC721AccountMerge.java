...
//            			hMap.put(name, arrayToList(account, emailList));
    ...
    private static List<String> getMergedAccount(List<Integer> indexList, List<List<String>> accounts) {
...
//    	accounts.add(convertStringArrayToArraylist(new String[]{"John", "johnsmith@mail.com", "john00@mail.com"}));
//    	accounts.add(convertStringArrayToArraylist(new String[]{"John", "johnnybravo@mail.com"}));
