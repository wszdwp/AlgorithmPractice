...
//    You can assume that you can always reach the last index.
    ...
    private void jumpHelper(int[] nums, int start, ArrayList<Integer> steps, ArrayList<ArrayList<Integer>> ans) {
    ...
    public static void main(String[] args) {
        ...
        int[] nums = {6,2,6,1,7,9,3,5,3,7,2,8,9,4,7,7,2,2,8,4,6,6,1,3};     //time limit
