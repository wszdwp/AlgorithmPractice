...
public class BuildTreeFromPreInOrder_105 {
    ...
    private TreeNode helper(int[] preorder, int preL, int preR, int[] inorder, int inL, int inR, HashMap<Integer, Integer> inMap) {
