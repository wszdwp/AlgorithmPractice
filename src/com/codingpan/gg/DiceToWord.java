...
public class DiceToWord {
	// N 6-face dices, each side of the dice is a letter, given a word ask if the combination of dice can form to this word.
	...
	public boolean isAchievable(String[] dices, String word) {
		...
		Arrays.sort(matchedFaces, new Comparator<String>(){
	...
	private boolean helper(String[] faces, int s, int idx, String word, ArrayList<String> cur, ArrayList<String> res) {
