package com.codingpan.searching;
...
public class Searching {
     ...
     * @param ans
     */
    public void permutation(int[] nums, int n, boolean[] used, List<Integer> cur, List<List<Integer>> ans) {
        if (cur.size() == n) {
            ans.add(new ArrayList<Integer>(cur));
            return;
        }
    ...
    public static void main(String[] args) {
        Searching solu = new Searching();

        // test subset and combination
        int n = 4;
        int[] nums = new int[n];
